...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<AppResponse<Void>> handleException(Exception ex) {
        ...
        AppResponse<Void> response = AppResponse.responseFail(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage());
    ...
    protected ResponseEntity<AppResponse<Void>> handleAuthorizeException(Exception ex) {
        ...
        AppResponse<Void> response = AppResponse.responseFail(HttpStatus.UNAUTHORIZED, ex.getMessage());
